antikythera_dep = {:antikythera, [github: "access-company/antikythera", ref: "48bec6a3f8bb27dde3e6b783829199169aae80db"]}
...
try do
  ...
  defmodule AntikytheraTestInstance.Mixfile do
    use Mix.Project
